...
for i in range(physTools.nRegions):
    branches_info['electronContainmentEnergy_x{}'.format(i+1)] = {'rtype': float, 'default': 0.}
    branches_info['photonContainmentEnergy_x{}'.format(i+1)]   = {'rtype': float, 'default': 0.}
    branches_info['outsideContainmentEnergy_x{}'.format(i+1)]  = {'rtype': float, 'default': 0.}
    branches_info['outsideContainmentNHits_x{}'.format(i+1)]   = {'rtype': int,   'default': 0 }
    branches_info['outsideContainmentXStd_x{}'.format(i+1)]    = {'rtype': float, 'default': 0.}
    branches_info['outsideContainmentYStd_x{}'.format(i+1)]    = {'rtype': float, 'default': 0.}
